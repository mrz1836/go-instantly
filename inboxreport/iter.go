...
// nil *Report, and stops early when the context is canceled.
func (s *Service) ListIter(ctx context.Context, testID string, opts ...ListOption) iter.Seq2[*Report, error] {
