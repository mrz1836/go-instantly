...
// WithTagIDs restricts results to campaigns with any of the given tag ids,
...
// WithStartDate restricts analytics to on or after the given date.
...
// WithEndDate restricts analytics to on or before the given date.
